const myData = [
    { id: 1, region: 'Økonomi', value: 12 },
    { id: 2, region: 'Eksamen', value: 16 },
    { id: 3, region: 'Trivsel', value: 10 },
    { id: 4, region: 'Ophør', value: 4 }
];
...
const chartContainer = d3
    ...
    .attr('height', chartHeight + (margins.ertical * 2));
